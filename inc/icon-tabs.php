      ...
      <div class="col-lg-2">
        <ul class="nav nav-tabs h-100" id="myTab" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <?php $is_first_tab = (get_row_index() == 1); ?>
            <button class="nav-link<?php if ($is_first_tab) echo ' active'; ?>" id="tab-<?php echo get_row_index(); ?>"
              data-bs-toggle="tab" data-bs-target="#tab-pane-<?php echo get_row_index(); ?>" type="button" role="tab"
              aria-controls="tab-pane-<?php echo get_row_index(); ?>"
          ...
          <div class="tab-pane fade <?php if ($is_first_tab_content) echo ' active show'; ?>"
            ...
            <div class="island background-white h-100">
              <div class="row">
                ...
                <div class="col-lg-8">
                  <h2>
                    <span class="eyebrow"><?php echo str_pad(get_row_index(), 2, '0', STR_PAD_LEFT); ?></span>

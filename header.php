  ...
  <nav class="navbar navbar-expand-xl">
    <div class="container">
      <a class="navbar-brand" href="#">
        <img src="./assets/img/authentic-brand-logo.svg" alt="">
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-3">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link" data-bs-toggle="modal" data-bs-target="#searchModal" aria-label="Open search">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewBox="0 0 16 17" fill="none">
                <circle cx="7.74142" cy="8.03319" r="6.74142" stroke="#00B4AD" stroke-width="1.5" stroke-linecap="round"
